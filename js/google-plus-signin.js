...
angular.module('googlePlusSignin', []).
  ...
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      (function() {
        ...
        po.src = 'https://apis.google.com/js/client:plusone.js?onload=onGapiClientLoad'; //MSO - 20140805 - After the client library is loaded, load the backend api
